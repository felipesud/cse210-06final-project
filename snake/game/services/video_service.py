...
class VideoService:
    ...
    def draw_actor(self, actor, centered=False,color=''):
        ...
        if not(color=='G') and not(color=='R')and not(color=='RANDOM'):
        ...
        if color=='R':
            ...
            color=(randint(1,255),randint(1,255),randint(1,255),255)
            pyray.draw_text(text, x, y, font_size, color)
            return
        pyray.draw_text(text, x, y, font_size, color)
        
    def draw_actors(self, actors, centered=False,color=''):
        ...
        """ 
        for actor in actors:
            self.draw_actor(actor, centered,color)
